            ...
            <div className="space-y-8">
                ...
                <div className="grid md:grid-cols-2 gap-10">
                    <div>
                        ...
                        <input type="text" value={params.userAddress || ''} onChange={e => handleChange('userAddress', e.target.value)} className={inputStyles} placeholder="City, Country" />
                    </div>
                    <div>
                        <label className={labelStyles}>Website</label>
                        <input type="url" value={params.userWebsite || ''} onChange={e => handleChange('userWebsite', e.target.value)} className={inputStyles} placeholder="https://example.com" />
                    </div>
                </div>
            </div>
                ...
                <div className="p-8 border-2 border-dashed border-stone-200 rounded-xl hover:border-bronze-400 transition-colors text-center group bg-stone-50/30">
                    ...
                    <label htmlFor="doc-upload" className="cursor-pointer flex flex-col items-center justify-center">
                        ...
                        <span className="text-sm font-bold text-stone-700 group-hover:text-stone-900">
                            {params.uploadedFileName ? params.uploadedFileName : "Upload Strategic Documents"}
                        </span>
                        <span className="text-xs text-stone-400 mt-2">
                            {params.uploadedFileName ? "Click to replace" : "PDF, DOCX, or TXT context."}
                        </span>
                    </label>
                </div>
            </div>
