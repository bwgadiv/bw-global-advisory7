...
type ViewMode = 'command-center' | 'intelligence-system' | 'report-generator' | 'live-feed' | 'admin-dashboard' | 'legal-hub';
...
const App: React.FC = () => {
    ...
    const handleEscape = useCallback(() => {
        if (viewMode !== 'command-center' && viewMode !== 'admin-dashboard' && viewMode !== 'legal-hub') {
            ...
            // If in legal hub, go back to where we were, or command center
            // For simplicity, go to command center if logged in
            setViewMode('command-center');
        }
    }, [viewMode]);
